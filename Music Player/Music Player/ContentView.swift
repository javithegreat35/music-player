...
struct MusicPlayer : View {
    ...
    @State var songs = ["lose yourself", "Swimming-Pools-Drank"]
    @State var current = 0
    ...
    var body : some View{
        ...
        VStack(spacing: 20){
            ...
            Image(uiImage: self.data.count == 0 ? UIImage(named: "musicicon")! : UIImage(data: self.data)!)
                .resizable()
                .frame(width: self.data.count == 0 ? 250: nil, height: 250)
                .cornerRadius(15)
            
            Text(self.artist).font(.largeTitle).padding(.top)
